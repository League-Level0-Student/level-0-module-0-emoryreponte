...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String adjective = JOptionPane.showInputDialog("Piranhas are more what during the day");
		// Get the player to enter a type of liquid
		String liquid = JOptionPane.showInputDialog("what liquid are Piranhas atracted to");
		// Get the player to enter a body part
		String bodypart = JOptionPane.showInputDialog("what body part are Piranhas going to bite if you...");
		// Get the player to enter a verb
		String verb = JOptionPane.showInputDialog("you do what action");
		// Get the player to enter a place
		String place = JOptionPane.showInputDialog("if you have an open wound try to find another way to get back to where");
